    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPosition in self.allPositions:
                new[newPosition] += prob * newPosDist[newPosition]
        self.beliefs = new
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(0, self.numParticles):
            n = i % len(self.legalPositions)
            self.particles.append(self.legalPositions[n])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for p in self.particles:
            beliefDistribution[p] += self.getObservationProb(observation, pacmanPosition, p, jailPosition)
    ...
    def elapseTime(self, gameState):
        ...
        for i in range(self.numParticles):
            ...
            if particle not in temp:
                temp[particle] = dist
            self.particles[i] = temp[particle].sample()
        ...
        for p in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                if ghostDistance == None:
                    ...
                    prob *= self.getObservationProb(ghostDistance, pacmanPosition, p[i], jailPosition)
            distribution[p] += prob
